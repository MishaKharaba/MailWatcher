...
public class SettingsActivity extends AppCompatPreferenceActivity {
    ...
    public static class PreferenceChangeListener implements Preference.OnPreferenceChangeListener {
        ...
        public boolean onPreferenceChange(Preference preference, Object value) {
            ...
            if (KEY_CHECK_MAIL_INTERVAL.equals(preference.getKey())) {
                preference.setSummary(stringValue + " min");
    ...
    public static abstract class BasePreferenceFragment extends PreferenceFragment {
        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            bindSummaryPreferences(savedInstanceState);
        }

        private void bindSummaryPreferences(Bundle savedInstanceState) {
